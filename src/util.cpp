...
glm::mat4 makeModel( const glm::vec3& origin, const glm::vec3& rotation, const glm::vec3& scale )
{
    ...
    glm::mat4 rx = glm::rotate( glm::mat4( 1 ), rotation.x, glm::vec3( 1, 0, 0 ) );
    glm::mat4 ry = glm::rotate( glm::mat4( 1 ), rotation.y, glm::vec3( 0, 1, 0 ) );
    glm::mat4 rz = glm::rotate( glm::mat4( 1 ), rotation.z, glm::vec3( 0, 0, 1 ) );
